...
/**
 * This is the model class for table "ksk_categories".
 *
 * @property string $id
 ...
 * @property KskPosts[] $kskPosts
 */
class KskCategories extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getKskPosts()
    {
        return $this->hasMany(KskPosts::className(), ['category_id' => 'id']);
    }
}
