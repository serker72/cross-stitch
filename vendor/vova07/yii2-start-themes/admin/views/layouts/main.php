                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    <?php if (Yii::$app->user->identity->photo) : ?>
                                        <?= Html::img(Yii::$app->user->identity->photo, ['class' => 'img-circle', 'alt' => Yii::$app->user->identity->username]) ?>
                                    <?php endif; ?>
                                    <p>
                                        <?= Yii::$app->user->identity->username ?> - <?= Yii::$app->authManager->getRole(Yii::$app->user->id) ?>
                                        <small><?= Yii::t('vova07/themes/admin', 'Member since') ?> <?= Yii::$app->user->identity->created_at ?></small>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p>
                                <?= Yii::t('vova07/themes/admin', 'Hello, {name}', ['name' => Yii::$app->user->identity->username]) ?>
                            </p>
                            <a>
